...
class ItemProtocol(Resource):
    ...
    def __init__(self, file_path, indents=4):
        ...
        # Note:
        # the item database uses the default
        # dictionary template as described in
        # ItemDatabase.py.
    ...
    def render_POST(self, request):
        ...
        Client passes in a product json of the format
        established in item database.
        '''
    ...
    def _authenticate_request(self,
                              request: Request):
        return self._authenticate_api_key(request) or \
